...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-dark-900 flex flex-col lg:flex-row safe-top">

      {/* ── Left panel (branding) — hidden on mobile, shown on lg+ ── */}
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:items-center lg:justify-center lg:bg-dark-800 lg:border-r lg:border-dark-500 lg:px-12">
        <img
          src={logoImg}
          alt="ແຈ່ວຫອມແຊບ"
          className="w-40 h-40 rounded-3xl object-cover mb-8 shadow-2xl border-4 border-brand-yellow/40"
        />
        <h1 className="text-brand-yellow font-bold text-5xl leading-tight">ຕິດຕາມ</h1>
        <h1 className="text-white font-bold text-4xl mt-1">ແຈ່ວຫອມແຊບ</h1>
        <p className="text-gray-400 text-lg mt-4">ຜະລິດ · ກະຈາຍ · ຂາຍ</p>
      ...
      {/* ── Right panel (form) ── */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 lg:px-12 lg:max-w-lg lg:mx-auto">
